...
$sql_chuong_list = "SELECT CHUONG_STT FROM chuong WHERE TRUYEN_ID='$truyen_id' and CHUONG_TRANGTHAI!=0";
...
// SQL lấy tên chương
$sql_chuong = "SELECT CHUONG_STT, CHUONG_NAME, CHUONG_NGAYDANG FROM chuong WHERE TRUYEN_ID='$truyen_id' and CHUONG_STT='$chuong_stt' and CHUONG_TRANGTHAI!=0";
...
if ($result_chuong->num_rows > 0) {
    echo "<a onclick='page_truyen(" . $truyen_id . ")' href='#'>
    <h1>" . $row_truyen['TRUYEN_NAME'] . "</h1>
    </a>
    ...
    <h2 style='color:red;' >KHÔNG THỂ XEM</h2>
    <h4>Ngày đăng: </h4>";
}
echo "
...
// SQL list hình ảnh
$sql_chuong_list_hinhanh = "SELECT CHUONG_NOIDUNG FROM chuong WHERE TRUYEN_ID='$truyen_id' and CHUONG_STT='$chuong_stt' and CHUONG_TRANGTHAI!=0 ";
